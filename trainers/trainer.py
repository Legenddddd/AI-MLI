...
def train_parser():
    ...
    parser.add_argument("--test_shot", nargs='+', help="number of support images per class for meta-testing during final test", type=int,default=5)
    ...
    parser.add_argument("--loss", choices=['AI_loss'], default='AI_loss')
...
class Train_Manager:
    ...
    def train(self, model):
        ...
        if args.decay_epoch is not None:
            ...
            total_epoch = args.epoch*args.stage# 400*2 400*3
